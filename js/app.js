(() => {
    ...
    da.init();
    const slider = () => {
        const sliderContent = document.querySelectorAll(".feedback_info-slider--content");
        ...
        function showSlide(index, direction) {
            ...
            if (direction === "right") sliderContent[index].classList.add("animate__slideInRight"); else if (direction === "left") sliderContent[index].classList.add("animate__slideInLeft");
        }
        leftBtn.addEventListener("click", (() => {
            currentSlide--;
            if (currentSlide < 0) currentSlide = sliderContent.length - 1;
            showSlide(currentSlide, "left");
        }));
        rightBtn.addEventListener("click", (() => {
            currentSlide++;
            if (currentSlide >= sliderContent.length) currentSlide = 0;
    ...
    const scrollToTop = () => {
        ...
        window.addEventListener("scroll", (() => {
            if (window.scrollY <= 950) scrollBtn.style.display = "none"; else scrollBtn.style.display = "block";
        }));
